...
public class CustomerCart extends AppCompatActivity {
    ...
    private void orderFood() {
        ...
        for (CustomerCartModel food : mList) {
            DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child(ORDER).child(food.getRestName()).child(firebaseUser.getUid());
    ...
    private void getCartFood() {
        ...
        if (firebaseUser.getUid() != null) {
            DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child(CART).child(userId);
